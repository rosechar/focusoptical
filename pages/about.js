...
function Services() {
    return (
            ...
            <Stack spacing={3} p={{xs:3}} pl={{md:30}} pr={{md:30}} >
              ...
              <Typography>
                Hello, my name is Tom Hamilton. I&apos;m an optician and I own and operate Focus Optical. I opened the store in 1984. We are a full service optical store, with eye examinations performed by Dr. Diane Galper, Optometrist.
              </Typography>
              <Typography>
